...
// export const lockerAddress = "0xC25689105C2F54cd7916e5c8101cFEBA7a08093E";
// export const swapTokenLockerFactory = '0x01c211e90F042D87faeDe2158b0D1025dF4734E7';
// export const airdropAddress = "0x7b997716c12f049C2c667da49C92788Ad195d703";
...
export const lockerAddress = "0x8ba74905c9ab0aa185e04498e2f83f8cdec20561";
// const swapTokenLockerFactory = '0x6a33a15d826e59792b60dec950e8af2fa7d58f9e';
// export const swapTokenLockerFactory = '0x01c211e90F042D87faeDe2158b0D1025dF4734E7';
export const swapTokenLockerFactory = '0xa21121b3dfd558a3a91d508049d1454073c134d4';
// export const airdropAddress = "0x75b320ab8c25dcc93afd2546c321cc15ce446678";
export const airdropAddress = "0xe9cac8190614cdac2e9caf44b2e407700a785603";
...
export const airdrop = async (provider, csvData, token, account) => {
    ...
    let result = await contract.methods.airdrop(token, _users, _amounts).send({
        from: account,
        value: BigInt(feeInETH * Math.pow(10, 18)).toString()
    });
    return result;
}